...
export function LaserPricingTable() {
  ...
  return (
    <section id="tarifs" className="scroll-mt-[86px] border-b border-border">
          ...
          >
            ...
            <span className="relative flex items-center justify-center">
              {showPing && !dropdownOpen && (
                <span className="absolute h-7 w-7 rounded-full bg-gold [animation:ping-fast_12s_ease-out_infinite]" />
              )}
